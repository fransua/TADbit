...
def parse_sam(f_names1, f_names2=None, out_file1=None, out_file2=None,
    ...
    Keep a summary of the results into 2 tab-separated files that will contain 6
       ...
       sequence length, position of the closest upstream RE site, position of
    ...
    :param None f_names2: a list of path to sam/bam files corresponding to the
       mapping of read2, can also  be just one file
    :param None out_file1: path to outfile tab separated format containing mapped
       read1 information
    :param None out_file1: path to outfile tab separated format containing mapped
       read2 information
    :param genome_seq: a dictionary generated by :func:`pytadbit.parsers.genome_parser.parse_fasta`.
